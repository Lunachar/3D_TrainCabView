...
namespace SortingStation.Tests
{
    public sealed class CabJourneyTests
    {
        ...
        [Test]
        public void UiSun_IsHiddenImmediatelyWhenTheRouteEntersATunnel()
        {
            Assert.That(CabJourneyDirector.ShouldShowUiSun(0.8f, true), Is.False);
            Assert.That(CabJourneyDirector.ShouldShowUiSun(0.8f, false), Is.True);
        }
