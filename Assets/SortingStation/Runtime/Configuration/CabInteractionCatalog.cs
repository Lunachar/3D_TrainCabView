...
namespace SortingStation
{
    ...
    public sealed class CabInteractionCatalog : ScriptableObject
    {
        ...
        [SerializeField, Range(45f, 140f)] private float stationApproachDistance = 45f;
        [SerializeField, Range(4f, 36f)] private float stationCrawlStartDistance = 4f;
        [SerializeField, Range(0.02f, 0.12f)] private float stationCrawlSpeed01 = 0.09f;
        [SerializeField, Range(0.5f, 4f)] private float stationStopTolerance = 2.8f;
        ...
        public float StationApproachDistance => Mathf.Clamp(stationApproachDistance, 45f, 140f);
        public float StationCrawlStartDistance => Mathf.Clamp(stationCrawlStartDistance, 4f, 36f);
        public float StationCrawlSpeed01 => Mathf.Clamp(stationCrawlSpeed01, 0.02f, 0.12f);
        public float StationStopTolerance => Mathf.Clamp(stationStopTolerance, 0.5f, 4f);
        ...
        public void ConfigureDefaults()
        {
            ...
            stationApproachDistance = 45f;
            stationCrawlStartDistance = 4f;
            stationCrawlSpeed01 = 0.09f;
            stationStopTolerance = 2.8f;
