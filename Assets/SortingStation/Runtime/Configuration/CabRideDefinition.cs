    ...
    public sealed class CabRideDefinition : ScriptableObject
    {
        ...
        public static CabControlBinding[] CreateDefaultControls()
        {
            return new[]
            {
                ...
                Binding(CabControlAction.Headlights, "Фары", "LIGHT", Key.F, 0.90f, 0.82f, 0.085f, 0.13f, false),
                ...
                Binding(CabControlAction.Bell, "Звонок", "BELL", Key.B, 0.322f, 0.80f, 0.09f, 0.125f, true),
                Binding(CabControlAction.Throttle, "Тяга", "+/-", Key.None, 0.63f, 0.185f, 0.53f, 0.15f, false),
                Binding(CabControlAction.Brake, "Тормоз", "STOP", Key.None, 0.945f, 0.305f, 0.10f, 0.24f, true),
                Binding(CabControlAction.Radio, "Радио", "RAD", Key.R, 0.165f, 0.215f, 0.315f, 0.34f, false),
                Binding(CabControlAction.Doors, "Двери", "<>", Key.D, 0.945f, 0.64f, 0.08f, 0.125f, false),
                Binding(CabControlAction.WindowHeater, "Обогрев стекла", "HOT", Key.G, 0.70f, 0.545f, 0.085f, 0.12f, false),
                Binding(CabControlAction.DispatcherRadio, "Связь", "CALL", Key.T, 0.522f, 0.54f, 0.085f, 0.125f, true)
            };
        }
