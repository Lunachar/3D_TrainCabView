...
{
    public sealed class CabWorldRenderer : MonoBehaviour, ICabWorldView
    {
        ...
        private CabJourneyRuntime journeyRuntime;
        ...
        {
            if (journeyRuntime != null) journeyRuntime.SegmentChanged -= OnRuntimeSegmentChanged;
            ...
            CabSceneryCatalog sceneryCatalog, UserPreferences userPreferences)
        {
            ...
            journeyRuntime = new CabJourneyRuntime(catalog != null ? catalog.RouteSegments : null, ride.RouteSeed);
            journeyRuntime.SegmentChanged += OnRuntimeSegmentChanged;
            ...
            currentSegment = journeyRuntime.CurrentSegment ?? FindStartingSegment();
        ...
        public void Advance(float speed01, float acceleration01, float unscaledDeltaTime)
        {
            ...
            journeyRuntime.Advance(distanceDelta);
            totalDistance = journeyRuntime.Distance;
            segmentDistance = journeyRuntime.SegmentDistance;
        ...
        public void SetUpcomingStation(CabStationDefinition station) { }
        public void SetPassengerReport(CabPassengerStopReport report) { }

        private void OnRuntimeSegmentChanged(RouteSegmentDefinition segment)
        {
        ...
        {
            if (catalog == null || journeyRuntime == null) return;
            if (journeyRuntime.SetSegment(type, progress, false))
            {
                currentSegment = journeyRuntime.CurrentSegment;
                segmentDistance = journeyRuntime.SegmentDistance;
                ApplySegment(currentSegment, true);
        ...
        public void SetPreviewDistance(float distance)
        {
            ...
            journeyRuntime?.SetDistance(totalDistance);
