...
namespace SortingStation
{
        ...
        IPointerEnterHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        private Action<PointerEventData> pointerActivated;
        ...
        /// <summary>Routes pointer activation using the touched point while preserving the normal keyboard action.</summary>
        public void ConfigurePointerActivation(Action<PointerEventData> onPointerActivated)
        {
            pointerActivated = onPointerActivated;
        }
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (!Interactable) return;
            AppServices.Instance?.Audio.Play(SoundCue.Tap);
            pointerActivated.Invoke(eventData);
        }
