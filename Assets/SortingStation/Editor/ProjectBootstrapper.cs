...
namespace SortingStation.EditorTools
{
    public static class ProjectBootstrapper
    {
        ...
        private static void ConfigureArtworkTextures()
        {
            ...
            if (Directory.Exists(CabControlsArtRoot))
            {
                foreach (string file in Directory.GetFiles(CabControlsArtRoot, "control-*-v1.png"))
                    ConfigureSingleSprite(file.Replace('\\', '/'));
            }
        ...
        private static void ConfigureControlArtwork(CabRideDefinition cab)
        {
            ...
            cab.AssignArtworkIfMissing(CabControlAction.Doors,
                AssetDatabase.LoadAssetAtPath<Sprite>(CabControlsArtRoot + "/control-doors-v1.png"));
            cab.AssignArtworkIfMissing(CabControlAction.WindowHeater,
                AssetDatabase.LoadAssetAtPath<Sprite>(CabControlsArtRoot + "/control-window-heater-v1.png"));
            cab.AssignArtworkIfMissing(CabControlAction.DispatcherRadio,
                AssetDatabase.LoadAssetAtPath<Sprite>(CabControlsArtRoot + "/control-dispatcher-v1.png"));
        }
